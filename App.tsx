...
const App: React.FC = () => {
  ...
  const handleSuggestionClick = (suggestion: string) => {
    // Intercept the wizard trigger suggestion
    if (language && suggestion === locales.defineProjectSuggestion[language]) {
      startProjectWizard();
    } else {
  ...
  return (
    <div className="bg-gray-100 dark:bg-[#0B1120] text-gray-800 dark:text-gray-200 font-sans min-h-screen flex flex-col items-center justify-center p-4 selection:bg-brand/70 selection:text-white">
      <div className="w-full max-w-2xl h-[95vh] max-h-[800px] bg-white dark:bg-[#111827] rounded-2xl shadow-2xl flex flex-col border border-gray-200 dark:border-gray-700">
