...
import { Message, Language, User, MeetingDetails, ProjectScope } from '../types';
...
const ChatInterface: React.FC<ChatInterfaceProps> = ({ 
    messages, user, onSendMessage, onSuggestionClick, onMeetingScheduled, onScopeSubmit, isLoading, isSummarizing, isChatEnded, 
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      if (selectedFile.type.startsWith('image/')) {
        ...
        const prompt = `The user uploaded a document named "${selectedFile.name}". Here is its content, please analyze it and ask a relevant question:\n\n---\n${extractedText}\n---\n\n${input}`;
